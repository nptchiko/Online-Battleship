...
class ControlPanel(tk.Frame):
    ...
    def _create_widgets(self):
        ...
        self.placement_frame = ttk.LabelFrame(self, text="Ship Placement", padding=10)
        ...
        ttk.Label(orientation_frame, text="Orientation:").pack(side="left", padx=5)
        ...
        ttk.Label(ai_selection_frame, text="AI Strategy:").pack(side="left", padx=5)
    ...
    def update_game_phase(self, phase):
        ...
        if phase == GamePhase.SETUP:
            ...
            if phase == GamePhase.PLAYER_TURN:
                self.status_label.config(foreground="#006400")  # Dark green for player's turn
            elif phase == GamePhase.AI_TURN:
                self.status_label.config(foreground="#8B0000")  # Dark red for AI's turn
