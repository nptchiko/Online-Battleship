...
class OptimizedProbabilityAI(AIStrategy):
    ...
    def __init__(self, board_size=10, ship_sizes=[5, 4, 3, 3, 2]):
        ...
        # Game state tracking
        self.ship_sizes = sorted(ship_sizes, reverse=True)  # Sort ship sizes list
    ...
    # Calculate probabilities based on possible ship placements
                ...
                for c in range(self.board_size):
                    ...
                    if c + ship_length <= self.board_size:
                        ...
                        for i in range(ship_length):
                            if not self._is_valid_coordinate(r, c + i):
                                can_place = False
                                break
                    ...
                    if r + ship_length <= self.board_size:
                        can_place = True
                        for i in range(ship_length):
                            if not self._is_valid_coordinate(r + i, c):
                                can_place = False
                                break
